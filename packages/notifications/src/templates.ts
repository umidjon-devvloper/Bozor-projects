...
export const TEMPLATES: readonly NotificationTemplate[] = [
  ...
  },
  {
    ...
    body: {
      uz: '{{productName}} ({{shopName}}) yana sotuvda — {{price}} soʻm.',
      uzCyrl: '{{productName}} ({{shopName}}) яна сотувда — {{price}} сўм.',
      ru: '{{productName}} ({{shopName}}) снова в продаже — {{price}} сум.',
      en: '{{productName}} at {{shopName}} is back in stock — {{price}} UZS.',
    },
    variables: ['productName', 'shopName', 'price'],
    targetType: 'product',
  },
  {
    type: 'favourite.price_dropped',
    category: NotificationCategory.MARKETING,
    channels: [Channel.PUSH, Channel.IN_APP],
    title: {
      uz: 'Narx tushdi',
    ...
    body: {
      uz: '{{productName}} ({{shopName}}) endi {{price}} soʻm.',
      uzCyrl: '{{productName}} ({{shopName}}) энди {{price}} сўм.',
      ru: '{{productName}} ({{shopName}}) теперь стоит {{price}} сум.',
      en: '{{productName}} at {{shopName}} is now {{price}} UZS.',
    },
    variables: ['productName', 'shopName', 'price'],
    targetType: 'product',
  },
